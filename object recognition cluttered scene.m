%% Step 1: Read Images
RGB = imread('image_0003.jpg');
boxImage = rgb2gray(RGB);
figure;
imshow(boxImage);
title('Image of an Aeroplane');

%%
% Read the target image containing a cluttered scene.
abc = imread('image_0004.jpg');
sceneImage = rgb2gray(abc);
figure; 
imshow(sceneImage);
title('Image of an Aeroplane with different angle');
...
title('100 Strongest Feature Points from Image 1');
hold on;
...
title('Object Detected: Aeroplane');
